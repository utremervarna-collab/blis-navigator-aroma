...
func applyNavigatorProductionHotfixes(resp *http.Response) error {
	...
	if path == "/dashboard.html" {
		...
		tag := []byte(`<script src="/navigator-production-entry-v1.js?v=20260830-overview-marker-lock-2"></script>`)
		...
		resp.Header.Set("X-BLIS-Navigator-Build", "20260830-overview-marker-lock-2")
	} else {
