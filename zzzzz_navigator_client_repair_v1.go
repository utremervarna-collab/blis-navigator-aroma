...
func init() {
	...
	authProxy.ModifyResponse = func(resp *http.Response) error {
		...
		return repairNavigatorClientResponse(resp)
	}
}

func repairNavigatorClientResponse(resp *http.Response) error {
	...
	// Native-link router + matching CSS. These fresh URLs prevent any browser
	...
	body = bytes.Replace(body,
		...
		[]byte(`/navigator-reference.js?v=20260825-router10-owners2`), -1)
	body = bytes.Replace(body,
	...
	if !bytes.Contains(body, []byte("navigator-data-core-v2.js")) {
		coreTag := []byte(`<script src="/navigator-data-core-v2.js?v=20260825-freeze7"></script>`)
	...
	if !bytes.Contains(body, []byte("navigator-client-value-pages-v1.css?v=20260825-freeze7")) {
		headAssets := `<link rel="stylesheet" href="/navigator-client-value-pages-v1.css?v=20260825-freeze7">
<link rel="stylesheet" href="/navigator-reputation-master.css?v=20260825-freeze7">
<link rel="stylesheet" href="/navigator-reputation-totem-3d-v40.css?v=20260825-freeze7">
<style id="blisLockedVisibilityRelease">.page{visibility:visible!important}.blis-commerce-launch,[data-blis-commerce-open]{display:none!important}</style>`
	...
	if !bytes.Contains(body, []byte("navigator-module-lock-v1.js?v=20260825-owners2")) {
		bodyAssets := `<script src="/navigator-architecture-v15.js?v=20260825-owners2"></script>
...
<script src="/navigator-competition-intelligence-v9.js?v=20260825-freeze7"></script>
...
<script src="/navigator-module-lock-v1.js?v=20260825-owners2"></script>
<script>(function(){
