/* BLIS Navigator — production entrypoint v24.
   Canonical data loader + one router + one owner per page.
   Legacy app.js is not part of the production UI path. */
(function(){
'use strict';
if(window.__BLIS_PRODUCTION_ENTRY_V24)return;window.__BLIS_PRODUCTION_ENTRY_V24=true;
const VERSION='20260829-visual-suite-data-isolated-1';
...
['__BLIS_REFERENCE_V15','__BLIS_REFERENCE_V16','__BLIS_CLIENT_UI_V3','__BLIS_DATA_LOADER_V1','__BLIS_INTELLIGENCE_STREAM_V3','__BLIS_EXECUTIVE_DATA_V1','__BLIS_EXECUTIVE_REPORTS_V1','__BLIS_COLOR_SYSTEM_V1','__BLIS_VISUAL_SUITE_V1','__BLIS_VISUAL_SUITE_MOTION_V1'].forEach(reset);
...
async function boot(){
 ...
 await safe('/navigator-visual-suite-v1.js');await safe('/navigator-visual-suite-motion-v1.js');
 ...
 document.documentElement.dataset.navigatorUi='visual-suite-data-isolated-1';
