...
'Оперативен принцип:':'Operating principle:','Оперативен принцип':'Operating principle',
'Navigator не показва технически health-метрики на клиента.':'Navigator does not show technical health metrics to the client.',
'Показва новите факти, техния source, значението им за казуса и дали наблюдението е актуално.':'It shows new facts, their source, their significance for the case and whether monitoring is current.',
...
'Оперативен принцип:':'Оперативный принцип:','Оперативен принцип':'Оперативный принцип',
'Navigator не показва технически health-метрики на клиента.':'Navigator не показывает клиенту технические health-метрики.',
'Показва новите факти, техния source, значението им за казуса и дали наблюдението е актуално.':'Он показывает новые факты, их источник, значение для кейса и актуальность мониторинга.',
'Показва новите факти, техния източник, значението им за казуса и дали наблюдението е актуално.':'Он показывает новые факты, их источник, значение для кейса и актуальность мониторинга.'
};
