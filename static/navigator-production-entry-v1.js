/* BLIS Navigator — production entrypoint v18.
   Stability build: one renderer owner per page + semantic color system. */
(function(){
'use strict';
...
['__BLIS_REFERENCE_V15','__BLIS_REFERENCE_V16','__BLIS_REPUTATION_V46','__BLIS_CLIENT_UI_V3','__BLIS_INTELLIGENCE_STREAM_V3','__BLIS_EXECUTIVE_DATA_V1','__BLIS_EXECUTIVE_UI_V2','__BLIS_EXECUTIVE_REPORTS_V1','__BLIS_COLOR_SYSTEM_V1'].forEach(reset);
