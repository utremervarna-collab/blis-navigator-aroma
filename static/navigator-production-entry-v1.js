...
(function(){
'use strict';
if(window.__BLIS_PRODUCTION_ENTRY_V42)return;window.__BLIS_PRODUCTION_ENTRY_V42=true;
const VERSION='20260906-key-factors-1';
...
async function boot(){
 forceBulgarianEarly();
 for(const css of ['/navigator-reference.css','/navigator-shell-master.css','/navigator-client-ui.css','/navigator-digital-master.css','/navigator-executive-layout-fix-v2.css','/navigator-executive-pages-4-9.css','/navigator-visual-special-v2.css','/navigator-signal-current-marker-v1.css'])await safeStyle(css);
 await safe('/navigator-system-structure-v1.js');
 await safe('/navigator-key-factors-v1.js');await safe('/navigator-perception-map.js');await safe('/navigator-market-system-v1.js');
 ...
 document.documentElement.dataset.navigatorUi='navigator3-key-factors';
