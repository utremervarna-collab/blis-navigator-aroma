...
(function(){
  ...
  function init(){initSelector();syncButton();window.dispatchEvent(new CustomEvent('blis:periodchange',{detail:{days,coverage:coverage()}}))}
