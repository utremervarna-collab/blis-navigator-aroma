...
#clients .clientCard:before{z-index:1!important;background:linear-gradient(180deg,rgba(8,23,42,.00) 12%,rgba(8,23,42,.08) 45%,rgba(8,23,42,.92) 100%)!important}
...
@media(max-width:720px){#clients .clientCard{min-height:305px}#clients .clientCardContent{padding:21px}#clients .clientCard h3{font-size:25px}}
	...
	grid := `<!-- home-client-profile-hero-images-v6 --><div class="clientGrid">` +
