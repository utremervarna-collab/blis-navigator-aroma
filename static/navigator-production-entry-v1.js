/* BLIS Navigator 3.0 — canonical production entrypoint.
   Български клиентски интерфейс, свързан аналитичен път, доказателства, клиентски бриф и конкурентни досиета. */
(function(){
'use strict';
if(window.__BLIS_PRODUCTION_ENTRY_V41)return;window.__BLIS_PRODUCTION_ENTRY_V41=true;
const VERSION='20260901-navigator3-bg-brief-1';
...
['__BLIS_REFERENCE_V16','__BLIS_REFERENCE_V17','__BLIS_REFERENCE_V18','__BLIS_CLIENT_UI_V3','__BLIS_CLIENT_HEADER_V1','__BLIS_CLIENT_HEADER_V2','__BLIS_CLIENT_BRANDING_V3','__BLIS_CLIENT_BRANDING_V4','__BLIS_CLIENT_BRANDING_V5','__BLIS_DATA_LOADER_V1','__BLIS_INTELLIGENCE_STREAM_V3','__BLIS_CLIENT_PERSPECTIVE_CLASSIFIER_V1','__BLIS_RISK_PRIORITY_SYNC_V1','__BLIS_EXECUTIVE_DATA_V1','__BLIS_EXECUTIVE_REPORTS_V1','__BLIS_COLOR_SYSTEM_V1','__BLIS_VISUAL_SUITE_V1','__BLIS_VISUAL_SUITE_MOTION_V1','__BLIS_VISUAL_SPECIAL_V2','__BLIS_NO_PAGE_NUMBERS_V1','__BLIS_OVERVIEW_CLIENT_HOME_V1','__BLIS_OVERVIEW_MARKER_FIX_V1','__BLIS_LANGUAGE_CLEANUP_V1','__BLIS_NAVIGATOR_3_CLIENT_CLARITY_V1','__BLIS_NAVIGATOR_3_EVIDENCE_V1','__BLIS_NAVIGATOR_3_COMPETITOR_DOSSIER_V1','__BLIS_NAVIGATOR_3_CLIENT_PROOF_V1','__BLIS_NAVIGATOR_3_CLIENT_BRIEF_V1'].forEach(reset);
...
async function boot(){
 ...
 await safe('/navigator-3-competitor-dossier-v1.js');
 await safe('/navigator-3-client-proof-v1.js');
 await safe('/navigator-3-client-brief-v1.js');
 ...
 document.documentElement.dataset.navigatorUi='navigator3-bg-client-brief';
