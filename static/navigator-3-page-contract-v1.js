...
const COPY={
  overview:{title:'Общ преглед',sub:'Обобщена картина на състоянието, движението и най-важните промени.'},
  social:{title:'Сигнали и наблюдение',sub:'Значими сигнали, видимост, рискове и възможности в текущата информационна среда.'},
  market:{title:'Пазар и репутация',sub:'Пазарни фактори, теми и промени във възприятието за бранда.'},
  competition:{title:'Конкуренция',sub:'Позиция, движение и значими промени спрямо конкурентите.'},
  history:{title:'Развитие и доклади',sub:'Динамика във времето, ключови събития и налични доклади.'},
