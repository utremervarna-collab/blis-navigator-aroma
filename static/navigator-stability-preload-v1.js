/* BLIS Navigator: stability compatibility preload v28.
   Loads legacy analytical helpers first, then one canonical client-intelligence owner.
   Includes persistent Environment title and Black Sea Center verified-data globe support. */
(function(){
'use strict';
if(window.__BLISStabilityPreloadV28)return;window.__BLISStabilityPreloadV28=true;
...
if(c==='black-sea-center')add('data-bsc-key-factors-globe-v2','/navigator-bsc-key-factors-globe-v2.js?v=20260907-bscglobe2');
