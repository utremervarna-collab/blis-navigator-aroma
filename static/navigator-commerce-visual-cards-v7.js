/* BLIS Navigator — approved exact service artwork loader. No generated visual proposals. */
(function(){
'use strict';
...
function loadApproved(){
  if(!document.querySelector('link[data-blis-exact-v8]')){
    const l=document.createElement('link');
    l.rel='stylesheet';
    l.href='/navigator-commerce-exact-cards-v8.css?v=20260824-approved-light4';
    l.dataset.blisExactV8='1';
    document.head.appendChild(l);
  }
  if(!document.querySelector('script[data-blis-exact-v8]')){
    const s=document.createElement('script');
    s.src='/navigator-commerce-exact-cards-v8.js?v=20260824-approved-light4';
    s.dataset.blisExactV8='1';
    s.onload=()=>window.BLISCommerceExactCardsV8?.enhance?.();
...
document.addEventListener('click',e=>{const more=e.target.closest?.('[data-bc7-addon-more]');if(more){e.preventDefault();addonModal(more.dataset.bc7AddonMore);return}if(e.target.closest?.('[data-bc3-tab],[data-bc3-detail],[data-bc3-request],[data-blis-commerce-open]'))queue()},false);
