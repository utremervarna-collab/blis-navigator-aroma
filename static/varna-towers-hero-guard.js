/* Varna Towers — final static hero. */
(function(){
  'use strict';
  ...
  function apply(){
    ...
    if(!bg)return;
    bg.style.setProperty('background-image','url("/varna-towers-profile-hero-final.svg?v=20260818-final")','important');
    ...
    bg.dataset.varnaTowersHero='ready-final';
  }
