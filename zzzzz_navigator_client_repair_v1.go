...
func init() {
	...
	authProxy.ModifyResponse = func(resp *http.Response) error {
		...
		body = bytes.Replace(body,
			...
			[]byte(`/navigator-reference.js?v=20260825-router9-v15owners1`), -1)
		body = bytes.Replace(body,
...
<style id="blisLockedVisibilityRelease">.page{visibility:visible!important}.blis-commerce-launch,[data-blis-commerce-open]{display:none!important}</style>`
		...
		if !bytes.Contains(body, []byte("navigator-module-lock-v1.js?v=20260825-v15owners1")) {
			bodyAssets := `<script src="/navigator-architecture-v15.js?v=20260825-v15owners1"></script>
...
<script src="/navigator-module-lock-v1.js?v=20260825-v15owners1"></script>
<script>(function(){
