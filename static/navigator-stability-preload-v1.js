/* BLIS Navigator: stability compatibility preload v29.
   Event-driven helpers with optimized Black Sea Center shell and globe. */
(function(){
'use strict';
if(window.__BLISStabilityPreloadV29)return;window.__BLISStabilityPreloadV29=true;
...
add('data-black-sea-center-client-v3','/navigator-black-sea-center-v1.js?v=20260907-bsc3');
})();