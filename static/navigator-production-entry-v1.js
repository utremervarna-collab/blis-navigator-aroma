...
const VERSION='20260901-navigator3-bg-dossier-1';
...
async function boot(){
 ...
 document.documentElement.dataset.navigatorUi='navigator3-bg-client-dossier';
