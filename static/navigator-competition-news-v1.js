...
let apiRows=[],apiClient='',apiUpdated=0,apiBusy=false,syncTimer=0,renderTimer=0;
...
function boot(){css();cleanMarket();schedule(250);syncAPI(true);setTimeout(()=>schedule(0),900);setTimeout(cleanMarket,2200);setInterval(()=>syncAPI(false),180000)}
