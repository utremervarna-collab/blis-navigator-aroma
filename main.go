...
func reportContent(c *Client, id string) (string, string) {
	name := c.Name
	if c != nil && c.Slug == "black-sea-center" {
		switch id {
		case "digital":
			return "Дигитално и публично присъствие – " + name,
				"<p>Месечният анализ проследява официалния сайт, публичните страници за офис площи, видимостта на проекта в търсене и медии, както и публичните препратки от наематели и партньори.</p><div class='box'><b>Основен фокус:</b> актуалност на офисното предложение, публична откриваемост, tenant proof, контактни и leasing точки, промени в съдържанието и видимостта.</div>"
		case "reputation":
			return "Репутация и информационна среда – " + name,
				"<p>Анализ на публичните споменавания и темите около Black Sea Center, включително корпоративни наематели, услуги, достъпност, локация и външни оценки, когато са налични.</p><div class='box'><b>Основен фокус:</b> повтарящи се теми, позитивни и негативни сигнали, надеждност на източниците и промени, които могат да влияят върху възприятието на офисния комплекс.</div>"
		case "signals":
			return "Пазарни и leasing сигнали – " + name,
				"<p>Проследяване на публично наблюдаемите промени в офисния пазар и около самия комплекс: нови или напускащи наематели, свободни площи, корпоративна активност, инфраструктура, услуги и инвестиционни движения.</p><div class='box'><b>Основен фокус:</b> tenant activity, офисно търсене, availability, локационни фактори, услуги и конкурентни движения във Варна.</div>"
		case "competitive":
			return "Конкурентна офисна среда – " + name,
				"<p>Съпоставка на Black Sea Center с наблюдаваните офисни конкуренти във Варна по еднакъв публичен набор от сигнали, без изкуствено класиране при липса на съпоставим индекс.</p><div class='box'><b>Основен фокус:</b> Varna Towers, Business Park Varna, Landmark Centre Varna и Комфорт Бизнес Център; наематели, свободни площи, услуги, паркиране, leasing активност, инвестиции и публична комуникация.</div>"
		case "summary":
			return "Месечно обобщение – " + name,
				"<p>Обобщение на най-важните промени за Black Sea Center през периода: публични споменавания, tenant и leasing сигнали, конкурентни движения, промени в средата и теми, които изискват последващо наблюдение.</p>"
		}
	}
	if id == "digital" {
