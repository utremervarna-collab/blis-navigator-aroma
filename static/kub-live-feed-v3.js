/* BLIS KUB Monitoring Feed v3 — canonical client-side renderer.
   The API is the live source of truth. Verified publisher items are used only as
   an immediate startup floor while the first API request is connecting. */
(function(){
'use strict';
...
const bootstrap=[
 {published_at:'2026-09-11T14:22:00+03:00',source:'Радио Варна / БНР',title:'Забраниха достъпа до пет незаконни строежа в местността „Баба Алино“',text:'Служители на Община Варна са запечатали на място пет строежа в „Баба Алино“ и е наложена забрана за достъп. Според публикацията при многократните проверки в сградите не са установени хора, а Общината и „Общинска полиция“ ще следят за спазване на забраната.',url:'https://bnrnews.bg/main/post/527204/zabraniha-dostapa-do-pet-nezakonni-stroezha-v-mestnostta-baba-alino',severity:'critical',relevance:100},
 {published_at:'2026-09-11T10:10:00+03:00',source:'Радио Варна / БНР',title:'„Баба Алино“ и Българското Черноморие в центъра на архитектурна дискусия във Варна',text:'Казусът „Баба Алино“ е включен в професионалната дискусия „Архитектът и морето“ за устройството на крайбрежните територии и баланса между обществения и инвестиционния интерес.',url:'https://bnrnews.bg/varna/post/526983/baba-alino-i-balgarskoto-chernomorie-v-tsentara-na-arhitekturna-diskusiya-vav-varna',severity:'high',relevance:90},
 {published_at:'2026-09-10T00:00:00+03:00',source:'Филтър',title:'„Медийната пушилка Баба Алино“',text:'Коментарна публикация във „Филтър“ оспорва публичния разказ, че действията на институциите решават казуса „Баба Алино“, и поддържа кризисната тема активна в информационната среда.',url:'https://filternews.bg/medijnata-pushilka-baba-alino/',severity:'high',relevance:92},
 {published_at:'2026-09-09T17:25:00+03:00',source:'Varna24.bg',title:'Адвокат за „Баба Алино“: Собственици ще търсят правата си',text:'Varna24.bg публикува становище на адвокат на собственици в „Баба Алино“, според което те не са били адресати на заповедта на кмета и възнамеряват да търсят правата си, включително по европейски ред.',url:'https://www.varna24.bg/novini/varna/Advokat-za-Baba-Alino-Sobstvenici-ne-sa-uvedomeni-i-ne-sa-adresati-na-zapovedta-na-kmeta-ot-01092025g-Shte-tursyat-pravata-si-3022574',severity:'high',relevance:96},
 {published_at:'2026-09-09T14:58:00+03:00',source:'БНТ',title:'Варненският административен съд прекрати делото срещу предписанието за спиране на тока в „Баба Алино“',text:'БНТ отразява решението на Административния съд – Варна за прекратяване на делото по жалбата срещу предписанието за спиране на електрозахранването.',url:'https://bntnews.bg/news/varnenskiyat-administrativen-sad-prekrati-deloto-sreshtu-zadalzhitelnoto-predpisanie-za-spirane-na-toka-v-baba-alino-1411599news.html',severity:'critical',relevance:98},
 {published_at:'2026-09-09T14:13:00+03:00',source:'Труд news',title:'Съдът отряза претенциите срещу спирането на тока в „Баба Алино“',text:'„Труд news“ отразява прекратяването на административното дело срещу предписанието за спиране на електрозахранването към част от постройките в „Баба Алино“.',url:'https://trud.bg/a/articles/sadat-otriaza-pretentsiite-sreshtu-spiraneto-na-toka-v-baba-alino',severity:'critical',relevance:97},
 {published_at:'2026-09-09T14:10:00+03:00',source:'БТА',title:'Варненският административен съд прекрати делото срещу предписанието за спиране на тока в Баба Алино',text:'БТА съобщава, че Административният съд – Варна е прекратил делото по жалбата на „Форест клуб Варна“ ООД срещу задължително предписание на „Електроразпределение Север“ за спиране на тока към няколко постройки.',url:'https://www.bta.bg/bg/news/bulgaria/regional-news/oblast-varna/1200678-varnenskiyat-administrativen-sad-prekrati-deloto-sreshtu-zadalzhitelnoto-predpis',severity:'critical',relevance:98},
 {published_at:'2026-09-09T10:02:00+03:00',source:'Dir.bg',title:'„Възраждане“ постави въпроси към ДАНС за Невзоров; парламентът отхвърли изслушването',text:'Dir.bg отразява парламентарния спор и отправените твърдения и въпроси към ДАНС относно Олег Невзоров и КУБ. Твърденията са представени като политически обвинения, а не като установени факти.',url:'https://dnes.dir.bg/politika/vazrazhdane-pita-dans-prodalzhava-li-nevzorov-da-vkarva-pari-i-orazhiya-v-chuvali',severity:'critical',relevance:100},
 {published_at:'2026-09-09T09:31:00+03:00',source:'БТА',title:'Парламентът отхвърли искане за изслушване относно корпорация КУБ',text:'БТА съобщава, че Народното събрание е отхвърлило предложение за изслушване на председателя на ДАНС относно твърдения за дейността на КУБ и нейния собственик Олег Невзоров.',url:'https://www.bta.bg/bg/news/1200403-parlamentat-othvarli-dve-iskaniya-na-vazrazhdane-za-izslushvaniya-otnosno-rast',severity:'critical',relevance:100},
 {published_at:'2026-09-08T15:09:00+03:00',source:'FrogNews',title:'Хората в „Баба Алино“ без ток и вода: Искат решение, готови са да сезират ЕС',text:'FrogNews отразява исканията на собственици за среща с кмета и за институционално решение, на фона на прекъснат ток и вода в част от комплекса.',url:'https://frognews.bg/novini/horata-baba-alino-bez-tok-voda-iskat-reshenie-gotovi-sezirat.html',severity:'critical',relevance:94},
 {published_at:'2026-09-08T11:03:00+03:00',source:'Moreto.net',title:'Жители на комплекс в „Баба Алино“ настояват за спешна среща с кмета на Варна и диалог с институциите',text:'Moreto.net отразява призива на жители на Forest Club за спешна среща с кмета, общинската администрация и юристи по текущия казус.',url:'https://www.moreto.net/novini.php?c=09&n=535068',severity:'high',relevance:92},
 {published_at:'2026-09-08T10:58:00+03:00',source:'VarnaUtre.bg',title:'Собственици на имоти във Forest Club искат спешна среща с кмета на Варна',text:'VarnaUtre.bg публикува позицията на собственици в Forest Club и искането им за работна група и диалог с институциите.',url:'https://varnautre.bg/2026/09/08/652982-sobstvenitsi_na_imoti_vuv_forest_clubiskat_speshna_sreshta_s_kmeta_na_varna',severity:'high',relevance:92},
 {published_at:'2026-09-08T09:40:00+03:00',source:'Dir.bg',title:'Жители от комплекса в Баба Алино искат лична среща с кмета на Варна',text:'Dir.bg отразява призива за лична среща с кмета и създаване на работна група за спорните казуси около Forest Club и „Баба Алино“.',url:'https://dnes.dir.bg/varna/zhiteli-ot-kompleksa-v-baba-alino-iskat-lichna-sreshta-s-kmeta-na-varna',severity:'high',relevance:94},
 {published_at:'2026-09-08T08:55:00+03:00',source:'Евроком',title:'„Домовете ни са заложник на спор“: Жители на Баба Алино настояват за среща с кмета',text:'Евроком отразява позицията на жители на Forest Club, които искат среща с кмета, индивидуален преглед на документите и предупреждават за възможно сезиране на европейски институции.',url:'https://eurocom.bg/2026/09/08/domovete-ni-sa-zalozhnik-na-spor-zhiteli-na-baba-alino-nastoyavat-za-sreshta-s-kmeta/',severity:'high',relevance:93},
 {published_at:'2026-09-08T08:46:00+03:00',source:'БГНЕС',title:'Жители на Forest Club в Баба Алино настояват за среща с кмета на Варна и работна група',text:'БГНЕС публикува искането на жители на комплекса за пряк диалог с институциите и работна група, като материалът е част от активния медиен цикъл по казуса „Баба Алино“.',url:'https://www.bgnes.bg/jiteli-na-forest-club-v-baba-alino-nastoqvat-za-sreshta-s-kmeta-na-varna-i-rabotna-grupa',severity:'high',relevance:94},
 {published_at:'2026-09-08T08:13:00+03:00',source:'Радио Варна / БНР',title:'Казусът „Баба Алино“: Жители настояват за лична среща с кмета на Варна',text:'Радио Варна отразява отвореното писмо на жители на Forest Club с искане за лична среща с кмета и създаване на работна група.',url:'https://www.bnrnews.bg/varna/post/525331/kazusat-baba-alino-zhiteli-nastoyavat-za-lichna-sreshta-s-kmeta-na-varna-i-rabotna-grupa',severity:'high',relevance:94},
 {published_at:'2026-09-04T14:55:00+03:00',source:'БТА',title:'Съдът във Варна остави без уважение искането за спиране на изпълнението на заповедта за тока и водата в „Баба Алино“',text:'Административният съд – Варна оставя без уважение искането на „Форест клуб Варна“ ООД за спиране на изпълнението на заповедта в частта за прекъсване на електроснабдяването и водоподаването.',url:'https://www.bta.bg/bg/news/bulgaria/regional-news/varna/1198286-sadat-vav-varna-ostavi-bez-uvazhenie-iskaneto-za-spirane-na-izpalnenieto-na-zapo',severity:'critical',relevance:99},
