...
func applyNavigatorProductionHotfixes(resp *http.Response) error {
	...
	if path == "/dashboard.html" {
		...
		tag := []byte(`<script src="/navigator-production-entry-v1.js?v=20260829-visual-suite-1"></script>`)
		...
		resp.Header.Set("X-BLIS-Navigator-Build", "20260829-visual-suite-1")
	} else {
