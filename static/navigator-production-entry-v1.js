/* BLIS Navigator — production entrypoint v25.
   Canonical data loader + exact visual owners for Signals, Reputation and Risk. */
(function(){
'use strict';
if(window.__BLIS_PRODUCTION_ENTRY_V25)return;window.__BLIS_PRODUCTION_ENTRY_V25=true;
const VERSION='20260829-visual-special-v2';
...
['__BLIS_REFERENCE_V16','__BLIS_REFERENCE_V17','__BLIS_CLIENT_UI_V3','__BLIS_DATA_LOADER_V1','__BLIS_INTELLIGENCE_STREAM_V3','__BLIS_EXECUTIVE_DATA_V1','__BLIS_EXECUTIVE_REPORTS_V1','__BLIS_COLOR_SYSTEM_V1','__BLIS_VISUAL_SUITE_V1','__BLIS_VISUAL_SUITE_MOTION_V1','__BLIS_VISUAL_SPECIAL_V2'].forEach(reset);
...
async function boot(){
 ...
 reset('__BLIS_REFERENCE_V17');await safe('/navigator-reference.js');
 ...
 document.documentElement.dataset.navigatorUi='visual-special-v2';
