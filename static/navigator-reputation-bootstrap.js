/* BLIS Navigator — Reputation bootstrap v40. Stable + global metric inspector + corrected 3D client trophy. */
(function(){
'use strict';
...
function wrapRefGo(){const old=window.refGo;if(typeof old!=='function'||old.__repStable40)return false;const wrapped=function(id){const r=old.apply(this,arguments);if(id==='reputation')run(90,false);return r};wrapped.__repStable40=true;window.refGo=wrapped;return true}
function init(){
