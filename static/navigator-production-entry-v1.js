/* BLIS Navigator — production entrypoint v38.
   Verified client-logo header + Overview marker locked to curve + canonical visual owners. */
(function(){
'use strict';
if(window.__BLIS_PRODUCTION_ENTRY_V38)return;window.__BLIS_PRODUCTION_ENTRY_V38=true;
const VERSION='20260830-client-verified-logo-1';
...
['__BLIS_REFERENCE_V16','__BLIS_REFERENCE_V17','__BLIS_REFERENCE_V18','__BLIS_CLIENT_UI_V3','__BLIS_CLIENT_HEADER_V1','__BLIS_CLIENT_HEADER_V2','__BLIS_CLIENT_BRANDING_V3','__BLIS_CLIENT_BRANDING_V4','__BLIS_CLIENT_BRANDING_V5','__BLIS_DATA_LOADER_V1','__BLIS_INTELLIGENCE_STREAM_V3','__BLIS_EXECUTIVE_DATA_V1','__BLIS_EXECUTIVE_REPORTS_V1','__BLIS_COLOR_SYSTEM_V1','__BLIS_VISUAL_SUITE_V1','__BLIS_VISUAL_SUITE_MOTION_V1','__BLIS_VISUAL_SPECIAL_V2','__BLIS_NO_PAGE_NUMBERS_V1','__BLIS_OVERVIEW_CLIENT_HOME_V1','__BLIS_OVERVIEW_MARKER_FIX_V1','__BLIS_LANGUAGE_CLEANUP_V1'].forEach(reset);
...
async function boot(){
 ...
 document.documentElement.dataset.navigatorUi='client-verified-logo-1';
 ...
 setTimeout(()=>{window.BLISClientBrandingV5?.paint?.();window.BLISOverviewMarkerFixV1?.align?.();window.BLISColorSystemV1?.decorate?.();window.BLISNoPageNumbersV1?.clean?.();window.BLISLanguageCleanupV1?.clean?.()},100);
}
