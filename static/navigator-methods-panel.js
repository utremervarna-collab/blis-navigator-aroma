/* BLIS Navigator — isolated interactive calculation methods panel */
(function(){
  const methods=[
    ...
    {icon:'⚖',title:'Индексионна тежест',lead:'Различна тежест според типа показател',body:'Компонентите не участват механично с еднаква тежест. Социалните, дигиталните, репутационните, съдържателните и конкурентните сигнали се включват според логиката на съответния индекс.'},
