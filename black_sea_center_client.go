...
func blackSeaCenterBackfill() []Signal {
	return []Signal{
		...
		bscStaticSignal("CompanyBook", "registry", "https://companybook.bg/companies/205829188", "Промяна по БЛЕК СИЙ ЦЕНТЪР БиЕсСи ЕАД", "Публичният фирмен профил отчита промяна във внесения капитал на 19 август 2026 г.", "2026-08-19T00:00:00+03:00", "market", 88),
		bscStaticSignal("BabyPlanet", "web", "https://babyplanet.bg/support/help", "BabyPlanet посочва магазин в Black Sea Center", "Страницата за помощ посочва адрес бул. Владислав Варненчик 186, Black Sea Center, ет. 0. Последна актуализация 31 август 2026 г.", "2026-08-31T00:00:00+03:00", "market", 96),
		bscStaticSignal("BabyPlanet", "web", "https://babyplanet.bg/support/shipping", "BabyPlanet потвърждава адрес в Black Sea Center", "Страницата за доставка съдържа публично посочен адрес на физическия обект в Black Sea Center, ет. 0.", "2026-09-05T00:00:00+03:00", "market", 94),
		bscStaticSignal("BabyPlanet", "web", "https://babyplanet.bg/support/click-and-collect", "Вземане от магазина в Black Sea Center", "Страницата за Click & Collect посочва магазина на бул. Владислав Варненчик 186, Black Sea Center, ет. 0, Варна.", "2026-09-07T00:00:00+03:00", "market", 98),
		bscStaticSignal("Imot.bg", "web", "https://www.imot.bg/obiavi/prodazhbi/grad-varna/troshevo/p-8", "Локационно споменаване: Varna Mall (Black Sea Center)", "Публична имотна обява използва Black Sea Center като разпознаваем ориентир за локация в Трошево. Публикационна дата не е потвърдена, записът е маркиран при откриване.", "", "market", 82),
	}
}
